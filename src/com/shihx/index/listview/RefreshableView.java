...
public class RefreshableView extends LinearLayout implements OnTouchListener {
	...
	private void setIsAbleToPull(MotionEvent event){
		...
		if(fistChild != null){
			int fistVisiblePos = listView.getFirstVisiblePosition();
			if(fistVisiblePos ==0 && fistChild.getTop() ==0){
				if(!ableToPull)
					yDown = event.getRawY();
	...
	private void refreshUpdatedAtValue(){
		...
		long timeIntoFormat;String updateAtValue;
		if (lastUpdateTime == -1) {
