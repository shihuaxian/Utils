...
public class VideoUIFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView = inflater.inflate(R.layout.video_ui_fragment, container, false);
	...
	private void fillDataToListView(){
		...
		SimpleCursorAdapter adapter = new SimpleCursorAdapter(getActivity(), R.layout.media_item, mCursor, fromColumns, toLayoutIDs, 0);
